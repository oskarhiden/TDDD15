...
dim(results[which(results[,1]==TRUE | results[,2]==TRUE),])[1]

dim(results[which(results[,3]==TRUE | results[,4]==TRUE),])[1]

dim(results[which((results[,1]==TRUE | results[,2]==TRUE) & (results[,3]==FALSE & results[,4]==FALSE)),])[1]

dim(results[which((results[,3]==TRUE | results[,4]==TRUE) & (results[,1]==FALSE & results[,2]==FALSE)),])[1]
